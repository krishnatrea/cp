/* 
 ...
 ? In a single step he can choose an element of the sequence (let's denote it ak) and delete it, 
 ? at that all elements equal to ak + 1 and ak - 1 also must be deleted from the sequence. 
